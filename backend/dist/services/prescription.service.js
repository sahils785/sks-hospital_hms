...
exports.getAllPrescriptions = exports.getDoctorPrescriptions = exports.getPatientPrescriptions = exports.getPrescriptionByAppointmentId = exports.getPrescriptionById = exports.updatePrescription = exports.createPrescription = void 0;
const db_1 = __importDefault(require("../config/db"));
const errors_1 = require("../utils/errors");
const notification_service_1 = require("./notification.service");
const mapPrescriptionResponse = (prescription) => {
    if (!prescription)
        return null;
    const medicines = (prescription.medications || []).map((m) => ({
        name: m.medicineName,
        dosage: m.dosage || '',
...
const resolvePatientIdByName = async (patientName) => {
...
const resolveDoctorIdByName = async (doctorName) => {
...
const updatePrescription = async (id, data) => {
    const existing = await db_1.default.prescription.findUnique({
        where: { id },
    });
    if (!existing) {
